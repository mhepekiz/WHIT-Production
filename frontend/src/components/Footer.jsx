    ...
    <footer className="site-footer">
      <div className="footer-container">
        <div className="footer-content">
          ...
          {/* Column 2: For Recruiters & Companies */}
          <div className="footer-column">
            <h3 className="footer-title">For Recruiters & Companies</h3>
            <ul className="footer-links">
          ...
          <div className="footer-column footer-brand">
            <div className="brand-section">
              <Link to="/" className="footer-logo">
                <span className="logo-text">WhoIsHiringInTech</span>
              </Link>
              <p className="footer-slogan">
                Connecting tech talent with innovative companies. 
                Discover your next career opportunity or find the perfect candidate.
              </p>
            </div>
            ...
            <div className="social-section">
              ...
              <div className="social-links">
                <a 
                  href="https://twitter.com/whitjobs" 
                  target="_blank" 
                ...
                <a 
                  href="https://linkedin.com/company/whitjobs" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="social-link"
                  aria-label="LinkedIn"
                ...
                <a 
                  href="https://github.com/whitjobs" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="social-link"
                  aria-label="GitHub"
                ...
                <a 
                  href="https://instagram.com/whitjobs" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="social-link"
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="copyright">
              © {new Date().getFullYear()} WhoIsHiringInTech. All rights reserved.
            </p>
          </div>
        </div>
      </div>
